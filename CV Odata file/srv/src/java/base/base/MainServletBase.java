...
public abstract class MainServletBase extends DataServlet {
    ...
    public com.opensap.mobile.emina.proxy.EminaService service;
    ...
    public void init(javax.servlet.ServletConfig config) throws javax.servlet.ServletException {
        ...
        provider = new InMemoryDatabase("EminaService");
        com.opensap.mobile.emina.ProviderSettings.init((com.opensap.mobile.emina.MainServlet)this);
        com.opensap.mobile.emina.ProviderSettings.init(provider);
        service = new com.opensap.mobile.emina.proxy.EminaService(provider);
        ...
        this.loadInitialData(com.opensap.mobile.emina.TestSettings.TEST_MODE);
        RegisterHandlers.withServlet((com.opensap.mobile.emina.MainServlet)this);
        RegisterListeners.withServlet((com.opensap.mobile.emina.MainServlet)this);
